 ...
 */
package de.hybris.team5.storefront.controllers.misc;
...
import de.hybris.team5.storefront.controllers.ControllerConstants;
...
public class AddToCartController extends AbstractController
{
	...
	private static final String SHOWN_PRODUCT_COUNT = "team5b2bstorefront.storefront.minicart.shownProductCount";
	...
	public final String addQuickOrderToCart(@RequestBody final AddToCartOrderForm form, final Model model)
	{
		...
		final int maxQuickOrderEntries = Config.getInt("team5b2bstorefront.quick.order.rows.max", 25);
