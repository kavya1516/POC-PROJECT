 ...
 */
package de.hybris.team5.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(Team5FulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(Team5FulfilmentProcessConstants.PARENT_PROCESS);
