 ...
 */
package de.hybris.team5.core.suggestion;
...
import de.hybris.team5.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/team5core/test/testSimpleSuggestionService.csv", "utf-8");
	}
