...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/team5storefront/electronics/en",
						"https://electronics.local:9002/team5storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/team5storefront/electronics/en",
						"https://electronics.local:9002/team5storefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/team5storefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/team5storefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/team5storefront/electronics/en",
						"https://electronics.local:9002/team5storefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/team5storefront",
						"https://electronics.local:9002/team5storefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/team5storefront",
						"https://electronics.local:9002/team5storefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/team5storefront/electronics/en",
						"https://electronics.local:9002/team5storefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
