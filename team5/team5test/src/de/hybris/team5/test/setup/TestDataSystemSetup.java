 ...
 */
package de.hybris.team5.test.setup;
...
import de.hybris.team5.test.constants.Team5TestConstants;
import de.hybris.team5.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = Team5TestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/team5test/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/team5test/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/team5test/import/cstickets.impex");
			...
			importImpexFile(context, "/team5test/import/csquotes.impex");
		}
	}
}
